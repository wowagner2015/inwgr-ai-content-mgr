...
# Usage: ./setup_project_with_firebase.sh -d /path/to/projects -u github_username -p project_name
# Example: ./setup_project_with_firebase.sh -d /Users/wowagner/Documents/Projects -u wowagner2015 -p inwgr-ai-content-mgr
...
validate_project_name() {
    local name="$1"
    # Firebase project names must be lowercase, 6-30 characters, with letters, numbers, and hyphens only.
...
initialize_firebase() {
    ...
    # Optional: Configure Firebase CLI settings or add additional Firebase features here
}
...
initialize_firebase "$project_dir" "$project_name"
